...
class DKT(Module):
    ...
    def forward(self, q, r):
        ...
        """
        # Ensure that every x is uinque. For example... for n=100 questions
        # The index of each question is 0-99. But we also want to represent
        # correct/incorrect responses. So we add 100 to the index of each
        # question.
        # Inccorect responses are represented by [0,99] and correct responses
        # are represented by [100,199]
        x = q + self.num_q * r

        # Then this is passed to the embedding layer to get the embedding
